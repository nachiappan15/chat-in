...
const UserDetails = (props) => {
  ...
  return (
    <>
      <div className=" lg:h-32 h-24 w-95 rounded-lg flex flex-col  bg-layer1-500 ">
        {/* user Details */}
        <div className="flex items-center lg:gap-12 gap-3 px-4 py-2 border-b border-layer1-300">
          {/* user name */}
        ...
        <div className=" h-full w-full flex items-center lg:px-2 px-1">
          <button className=" bg-bckground lg:h-8 h-8 md:h-10 lg:px-4 px-2 lg:rounded-xl rounded-lg text-xs  text-black font-bold outline-none hover:scale-105 flex  items-center gap-1" onClick={elementAppear}>
             Room <FaPlus />
          </button>
           {/* icon contsiner */}
