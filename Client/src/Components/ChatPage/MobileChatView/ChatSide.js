  ...
  return (
    <div className="h-full w-full">
      <div className="h-full     flex flex-col items-center gap-4">
        <YellowNav openChat = {props.onClickHandler}/>
        <div className="w-95 h-56 flex-auto  mb-4  rounded-lg flex flex-col ">
          <div className="  h-full flex  flex-col-reverse   lg:mx-8 md:mx-2  px-2 flex-nowrap overflow-scroll">
            <MessageCard
              sent={false}
              messageText="desfhhoefhs fsyh8fhs8hSOUfh8hd  wdyw8egh ew8 ed8ughoufbh oueui ueuhef u u hufehuehufhuh hodfh8uehuahfohu efhoui fhououhdreoifhoidhf hhoudfhoi hoidfhjdfhfdhoiefhodefjvnouider hoijfoih pijdukukhk uufhu f usfgsf fgufg ug g vgug iusgicgi gg"
              time="7.00 pm"
            />
            <MessageCard
              sent={true}
              messageText="jdukukhk uufhu f usfgsf fgufg ug g vgug iusgicgi gg"
              time="7.00 pm"
            />
            <MessageCard
              sent={false}
