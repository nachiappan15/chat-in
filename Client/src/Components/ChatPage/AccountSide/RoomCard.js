...
const RoomCard = (props) => {
    return (
        <div className=" w-full lg:px-5 px-2 lg:py-2 py-1 flex flex-col bg-layer1-600  text-snowWhite rounded-md hover:bg-defaultYellow hover:text-card  hover:rounded-lg cursor-pointer" onClick={props.changeActiveChat} >
        {/* freined details */}
